...
public interface Minimizer {
     ...
     * </p>
     *
     * @param pathToLibraries the file path to the directory
     * @return an instance of the {@link Minimizer} that is being set up
     * @throws IOException in case there is a problem resolving the path
     */
     ...
     * </p>
     *
     * @param artifactLocations a {@link Set} of {@link File}s that are dependencies of this project
     * @return an instance of the {@link Minimizer} that is being set up
     */
     ...
     * </p>
     *
     * @param pathToOutput the path to the directory to serve as an output
     * @return an instance of the {@link Minimizer} that is being set up
     */
     ...
     * </p>
     *
     * @param jars an array of {@link JarFile} to be forcefully included
     * @return an instance of the {@link Minimizer} that is being set up
     */
     ...
     * </p>
     *
     * @param classes an array of {@link ClassName}s to be forcefully included
     * @return an instance of the {@link Minimizer} that is being set up
     */
     ...
     * @throws IOException if an error occurred while deleting the temporary files
     */
